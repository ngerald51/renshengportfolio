      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              A FINTECH professional with a passion for exploring new frontiers and ways to improve productivity. Highly motivated to be useful in challenging situations and thrive in collaborative team environments.
            </p>
            {/* BIOGRAPHY QUOTE */}
